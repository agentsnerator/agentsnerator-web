...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center relative overflow-hidden px-4">
      {/* Background glows */}
      <div className="absolute top-[-10%] right-[-5%] w-[400px] h-[400px] bg-primary/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-secondary/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      {/* Clerk SignIn component — styled via appearance */}
        ...
        <SignIn
          appearance={{
            ...
            elements: {
              ...
              identityPreviewText:   "text-on-surface font-body",
              identityPreviewEditButton: "text-primary font-label",
